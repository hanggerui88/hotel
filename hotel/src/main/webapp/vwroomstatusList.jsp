...
<body>
    <div class="x-nav">
      ...
      <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="vwroomstatusList" title="刷新">
        <i class="layui-icon" style="line-height:30px">⥁</i></a>
    </div>
    <div class="x-body">
      <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" method="post" action="vw_room_search">
            <input type="text" class="layui-input" name="ddate" id="ddate" placeholder="日期" lay-verify="">
            ...
            <input type="text" class="layui-input" name="rmNumber" id="rmNumber" placeholder="房间号码" lay-verify="">
